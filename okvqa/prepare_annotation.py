...
with open('/pr*/data/okvqa6_1/raw_data/train_36bbox_res_okvqa2.pickle', 'rb') as f:
    image_raw = pickle.load(f, encoding='iso-8859-1')
with open('/kb-vqa/data/ok-vqa/OpenEnded_mscoco_train2014_questions.json') as f:
    ques = json.load(f)
with open('/kb-vqa/data/ok-vqa/mscoco_train2014_annotations.json') as f:
...
with open('/kb-vqa/data/okvqa_train_raw_answer.json','w') as f:
